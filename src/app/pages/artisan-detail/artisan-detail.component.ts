...
@Component({
  ...
  //       <h2 class="text-2xl md:text-3xl font-bold text-dark-blue mb-8">Services Offered</h2>

  //       <div class="space-y-8">
  //         <app-service-card
  //           *ngFor="let service of artisan?.services"
  //           [name]="service.name"
  //           [description]="service.description"
  //           [price]="service.price"
  //           [experience]="service.experience"
  //           [images]="service.images"
  //           (interest)="onServiceInterest(service)">
  //         </app-service-card>

  //         <app-custom-service-form
  //           (submitted)="onCustomServiceSubmit($event)">
  //         </app-custom-service-form>
  //       </div>
  //     </div>
  //   </section>
...
export class ArtisanDetailComponent implements OnInit {
      ...
      services: [
        ...
        },
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1578749556591-ea5a3e3f56b5?w=500&q=80",
            "https://images.unsplash.com/photo-1610701596061-2ecf227e85b2?w=500&q=80",
          ],
        },
      ],
    },
  ...
  ngOnInit() {
    this.route.params.subscribe((params) => {
      ...
      this.artisan = this.artisans[artisanId] || null;
    });
  }

  onServiceInterest(service: any) {
    const message = `Thank you for your interest in "${service.name}"!\n\nWe'll contact you shortly to discuss your project.\n\nPrice Range: ${service.price}\nArtisan: ${this.artisan?.name}\nContact: ${this.artisan?.email}`;
    alert(message);
  }

  onCustomServiceSubmit(formData: any) {
    console.log("Custom Service Request:", formData);
    alert(
      "Thank you for your custom service request! We will contact you within 24 hours to discuss your project."
    );
  }
}
